...
const Logo = ({ size }) => (
  <div className="Logo">
    ...
    >
      ...
      {/* supp de "style={{ 'font-family': 'Kalimati', 'font-size': '39px', 'font-weight': 700, 'white-space': 'pre' }}" dans la balise ci-dessous */}
      <text fill="url(#paint5_linear_56_57)" x="-1.125" y="44.995">724</text>
      <defs>
        <linearGradient
